...
public class nd4j_ex4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(scalarVal.length());
        System.out.println(myArray.getInt(0,0));
        System.out.println(myArray.getDouble(0,0));
        System.out.println(myArray.getFloat(0,0));
        ...
        */
        ...
        INDArray row_2 = arr1.getRow(1);
        System.out.println(arr1);
        System.out.println(row_2);

        System.out.println(arr1.getRow(0).toString());
        System.out.println(arr1.getRow(0).length());
        arr1.putRow(0, Nd4j.zeros(1, arr1.getRow(0).length()));
        System.out.println(arr1);


        System.out.println(arr1.getColumn(1).toString());
        System.out.println(arr1.getColumn(1).length());
        arr1.putColumn(1, Nd4j.zeros(arr1.getColumn(1).length(), 1));
        System.out.println(arr1);

        arr1.putRow(1, Nd4j.ones(1, arr1.getRow(0).length()));
        System.out.println(arr1);

        INDArray a = arr1.get(new INDArrayIndex[] {NDArrayIndex.point(2), NDArrayIndex.interval(1, 4)});
        System.out.println(a);

        System.out.println(arr1.get(NDArrayIndex.point(2), NDArrayIndex.interval(1, 4)).toString());
