...
public class nd4j_ex10 {
    ...
    public static void main(String[] args) {
        ...
        */
        INDArray arr1 = Nd4j.randn(Nd4j.create(new int[]{3,3}), 123);
        INDArray arr2 = Nd4j.randn(Nd4j.create(new int[]{3,1}), 123);
        INDArray arr3 = arr1.mmul(arr2);
